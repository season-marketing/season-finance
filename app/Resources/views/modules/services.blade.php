<div class="js-component" id="services">
  <div class="bg-black text-white py-16 md:py-24">
    <div class="max-w-container-sm px-4 mx-auto text-lg md:text-2xl">
      ...
      <p class="mb-12 text-center font-bold text-yellow-300">THROUGH OUR 30+ BRANDS WE GENERATE TONS OF LEADS BY TIRELESSLY IMPROVING OUR CUSTOMER EXPERIENCE TO GIVE OUR BUYERS ACCESS TO A WHOLE WORLD OF PURCHASE.</p>
