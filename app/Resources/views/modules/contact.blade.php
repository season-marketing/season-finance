<div class="js-component" id="contact">
  <div class="grid grid-cols-12 text-lg md:text-2xl">
    <div class="col-span-12 md:col-span-5 bg-yellow-400 px-4 md:px-10 py-12 text-white">
      <div class="flex items-start">
        <div class="w-16"></div>
        <h2 class="mb-10 text-2xl md:text-4xl font-bold">CONTACT US</h2>
      </div>
    ...
    <div class="col-span-12 md:col-span-7 px-4 md:px-10 py-12">
      <h2 class="mb-4 text-2xl md:text-4xl font-bold text-center">GET IN TOUCH</h2>
      ...
      <form class="md:grid grid-cols-2 gap-10">
        ...
        <input name="email" type="email" placeholder="Email" class="w-full mb-5 md:mb-0 placeholder-black border-b border-yellow-300 focus:outline-none">
        ...
        <div class="col-span-2 flex mb-5 md:mb-0">
          ...
          <div class="flex">
            <div class="flex items-center">
              ...
              <input type="checkbox" name="UK" value="UK" class="mr-5">
            </div>
            <div class="flex items-center">
              <label for="US" class="mr-2">US</label>
              <input type="checkbox" name="US" value="US" class="mr-5">
            </div>
            <div class="flex items-center">
              <label for="AU" class="mr-2">AU</label>
              <input type="checkbox" name="AU" value="AU" class="mr-5">
            </div>
          </div>
        </div>
